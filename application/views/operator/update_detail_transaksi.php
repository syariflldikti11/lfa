...
?>
  <div class="container">
          ...
          <a href="<?php echo base_url('operator/detail_transaksi/'.$d->id_transaksi);?>"class="btn btn-dark me-2">Kembali</a>
...
<div class="card">
    ...
    echo form_open('operator/update_detail_transaksi','class="form-horizontal"'); ?>
                <div class="card-body">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="number" class="form-control" value="<?= $d->perpanjangan_stck; ?>"  name="perpanjangan_stck" id="perpanjangan_stck"  >
    
  </div>
   <div class="form-group">

    <label for="exampleInputEmail1">Nopol Pilihan</label>
    <input type="number" class="form-control" value="<?= $d->nopol_pilihan; ?>"  name="nopol_pilihan" id="nopol_pilihan"  >
    
  </div>
   <div class="form-group">

    <label for="exampleInputEmail1">Penalti Wilayah</label>
    <input type="number" class="form-control" value="<?= $d->penalti_wilayah; ?>"  name="penalti_wilayah" id="penalti_wilayah"  >
