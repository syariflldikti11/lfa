...
?>
  <div class="container">
          ...
          <a href="<?php echo base_url('operator/detail_tanda_terima/'.$id.'/'.$id_transaksi);?>"class="btn btn-dark me-2">Kembali</a>
...
<div class="card">
              <div class="card-header">
                <h3 class="card-title">Tambah Detail Tanda Terima Dokumen</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
    ...
    echo form_open('operator/tambah_detail_tanda_terima','class="form-horizontal"'); ?>
                <div class="card-body">
                 
                        <div class="form-group">
  <input type="hidden" class="form-control"  name="id_tanda_terima" value="<?= $id; ?>">
  ...
  <select class="js-example-basic-single form-select" style="width:100%"  name="id_detail_transaksi">
    ...
    <?php foreach ($dt_detail_transaksi as $h): ?> 
      <option value="<?= $h->id_detail_transaksi; ?>">
