              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                   ...
                   href="<?php echo base_url('admin/tambah_tanda_terima');?>" 
                      >
...
href="<?php echo base_url('admin/delete_tanda_terima/'.$d->id_tanda_terima);?>" 
> <i class="fa fa-trash"></i></a> <a  class="btn  btn-primary btn-sm" data-tooltip="tooltip"
  data-bs-placement="top"
  title="Edit" 
href="<?php echo base_url('admin/update_tanda_terima/'.$d->id_tanda_terima);?>" 
> <i class="fa fa-edit"></i></a>  <a  class="btn  btn-success btn-sm" data-tooltip="tooltip"
  data-bs-placement="top"
  title="Detail" 
href="<?php echo base_url('admin/detail_tanda_terima/'.$d->id_tanda_terima.'/'.$d->id_transaksi);?>" 
> <i class="fa fa-list"></i></a> 
<a  class="btn  btn-dark btn-sm" data-tooltip="tooltip"
  data-bs-placement="top"
  title="Tanda Terima" 
href="<?php echo base_url('admin/receipt/'.$d->id_tanda_terima);?>" 
